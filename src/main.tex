...
\DeclareCaptionFormat{myformat}{\fontsize{9pt}{12pt}\selectfont \textbf{#1#2}#3}
\captionsetup{format=myformat, font={stretch=0.8624267578125}, labelsep=period, tableposition=top, figureposition=bottom}
% (1*2355/2048) / (12/9) = 0.8624267578125
